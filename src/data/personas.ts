...
export const personas: Persona[] = [
  ...
  },
  {
    ...
    name: '学生/考生',
    icon: '📚',
    description: '关注升学考试、助学贷款、就业扶持等与学业和前途相关的政策',
    ...
    concernAreas: ['高考改革政策', '助学贷款申请', '奖学金评定', '招生计划', '就业扶持', '考研考公政策', '应届生补贴', '创业扶持'],
  },
  {
    id: 'elderly',
    name: '老年人',
    ...
    scene: '每月查养老金到账的时候',
    categories: ['social-insurance', 'medical', 'housing', 'pension', 'elderly'],
  ...
  },
  {
    ...
    scene: '每年自己申报个税的时候',
    categories: ['social-insurance', 'tax', 'pension', 'medical', 'employment'],
    keywords: ['灵活就业', '社保', '个税', '创业', '自雇', '个体', '缴费', '补贴', '申报', '小微企业', '营业执照', '养老金', '就业', '培训', '人才'],
